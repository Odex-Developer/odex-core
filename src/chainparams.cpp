...
public:
    CMainParams()
    {
        ...
        */
        ...
        vSeeds.push_back(CDNSSeedData("45.77.220.101", "45.77.220.101"));
        vSeeds.push_back(CDNSSeedData("149.28.239.242", "149.28.239.242"));
        vSeeds.push_back(CDNSSeedData("45.63.21.208", "45.63.21.208"));
