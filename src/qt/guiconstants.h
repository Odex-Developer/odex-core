...
/* Odex GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Odex"
#define QAPP_ORG_DOMAIN "odex.com"
#define QAPP_APP_NAME_DEFAULT "Odex-Qt"
#define QAPP_APP_NAME_TESTNET "Odex-Qt-testnet"
