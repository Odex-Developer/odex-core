 ...
 */
    ...
    typeWidget->addItem(tr("Received ODEX from zODEX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zODEX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zODEX));
