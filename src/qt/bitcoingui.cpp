                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Odex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Odex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and odex: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zODEX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Odex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Odex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Odex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Odex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Odex addresses"));
    ...
    openAction->setStatusTip(tr("Open a Odex: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Odex Core help message to get a list with possible Odex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Odex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Odex network", "", count));
}
...
{
    QString strTitle = tr("Odex Core"); // default title
