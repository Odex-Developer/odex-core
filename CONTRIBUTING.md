Contributing to Odex Core
============================

The Odex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Odex Core project, and is not to be
confused with overall Odex Network Protocol consensus changes.

Whether a pull request is merged into Odex Core rests with the project merge
...
Patches that change Odex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Odex consensus, it must have been
...
The project leader is the release manager for each Odex Core release.
