...
```bash
masternodename ipaddress:20149 genkey collateralTxID outputID
```

An example would be

```
mn1 127.0.0.2:20149 93HaYBVUCYjEMeeH1sBGLALQZE1Y1K6xiqgX37tGBDQL8Xg 2bcd3c84c84f7ea86e4e56834c2927a07f9e1871810b92e0d0324456a67c 0
```
