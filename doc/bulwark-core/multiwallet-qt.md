...
In order to support loading of multiple wallets in odex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is odex.cpp.
...
Changes to odex.cpp
----------------------
odex.cpp is the entry point into odex-qt, and as such, will require some minor modifications to provide hooks for
