...
1. Make sure you have the latest wallet version downloaded from our [Github](https://github.com/odex-crypto/Odex/releases) and the wallet is fully synced with atleast 100 ODEX in each input. Also make sure that each input has atleast 475 confirmations.
...
If it still doesn't work after following these steps, please join our [Discord](https://discord.me/odexcrypto) for further help.
