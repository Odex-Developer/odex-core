...
#   c) node1 mines 32 blocks, so now node 0 has 60001ODEX node 1 has 4250ODEX node2 has none.
#   d) node0 sends 601 ODEXto node2, in two transactions (301 ODEX then 300 ODEX.
